...
export function DesktopAuth() {
  ...
  const run = async (fn: () => Promise<unknown>, enter = false) => {
    ...
    try {
      await fn();
      if (enter) router.push("/onboarding");
    } catch (e) {
      setError(e instanceof Error ? e.message : "Unable to sign in. Retry.");
    } finally {
      setBusy(false);
    }
  };
    ...
    <div className="auth-layout">
      ...
      <section className="auth-card panel stack">
        ...
        <p className="tiny muted">
          No AI keys or live app connections needed. Demo data is separate from
          your real workspace.
        </p>
      </section>
    </div>
